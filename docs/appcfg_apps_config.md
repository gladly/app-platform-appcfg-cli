...
Create, copy, update, delete and check outdated configurations related to your Gladly app platform apps

### Synopsis

The "config" command provides tools to manage configurations for your Gladly app platform apps. It allows you to create new configurations, copy configurations, update existing ones, and remove those no longer needed.
...
* [appcfg apps config compatible](appcfg_apps_config_compatible.md)	 - Check if an existing configuration is compatible with a new major version of the configured application.
* [appcfg apps config copy](appcfg_apps_config_copy.md)	 - Copy a configuration from one app version to another
