...
* [appcfg add admin-ui](appcfg_add_admin-ui.md)	 - Create the admin UI form configuration to enable editing app configuration in the Gladly admin UI
...
* [appcfg add ui-form](appcfg_add_ui-form.md)	 - Create a UI form configuration folder and all relevant files
