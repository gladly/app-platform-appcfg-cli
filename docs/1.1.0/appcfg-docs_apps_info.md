## appcfg-docs apps info

Display detailed information about an application

### Synopsis

Display detailed information about a specified application by ID or name.

```
appcfg-docs apps info {application ID | application name} [flags]
```
