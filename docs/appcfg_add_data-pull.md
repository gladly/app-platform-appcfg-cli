...
```
  ...
  -d, --depends-on-types stringArray   comma separated list of data types that this data pull depends on
  -h, --help                           help for data-pull
  -m, --http-method string             one of GET, POST, PUT, PATCH or DELETE
```
